...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, enhanced, frame hidden, boxrule=0pt, colback={codebgcolor}, breakable]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
