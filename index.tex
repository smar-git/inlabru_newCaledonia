...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, breakable, colback={codebgcolor}, frame hidden, boxrule=0pt, enhanced]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
...
\item
  \textbf{Important!} Please use the instructions provided
