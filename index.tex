...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[colback={codebgcolor}, breakable, sharp corners, boxrule=0pt, enhanced, frame hidden]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
